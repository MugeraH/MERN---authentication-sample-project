...
import { rAuthApiWithAuth } from "../util/axiosUtils";
...
export const UserInfoPage = () => {
  ...
  const saveChanges = async () => {
    try {
      const response = await rAuthApiWithAuth().put(`/users/${id}`, {
        favoriteFood,
        hairColor,
        bio,
      });
  ...
  return (
    <div className="content-container">
      ...
      {!isVerified && (
        <div className="fail">
          You wont be able to make any changes until you verify your account by
          email
        </div>
      )}
      {showSuccessMessage && (
